...
class DecisionTreeClassifier():
    ...
    def information_gain(self, parent, l_child, r_child, mode="joint"):
        ...
        if mode=="gini":
            ...
            gain = 1 - abs((alpha*(self.entropy(parent) - (weight_l*self.entropy(l_child) + weight_r*self.entropy(r_child)))+(1-alpha)*(1 - (self.gini_index(parent) - (weight_l*self.gini_index(l_child) + weight_r*self.gini_index(r_child))))) - 0.5)
        else:
            gain = 1 - (self.entropy(parent) - (weight_l*self.entropy(l_child) + weight_r*self.entropy(r_child)))
